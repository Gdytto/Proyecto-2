...
public class TaskPP extends AppCompatActivity {
    ...
    public void loadDataList(Cursor cursor, ArrayList<HashMap<String, String>> dataList)
    {
        if(cursor!=null ) {
            ...
            while (cursor.isAfterLast() == false) {
                ...
                mapToday.put(KEY_DATE, Functionality.DateString(cursor.getString(2).toString(), "dd-MM-yyyy"));
    ...
    {
        Adapter adapter = new Adapter(activity, dataList);
